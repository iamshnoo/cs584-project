...
data1 = load_data("../../outputs/random_forest/valid_scores_RF_isot.json")
data2 = load_data("../../outputs/random_forest/valid_scores_RF_kaggle_fake_news.json")
data3 = load_data("../../outputs/random_forest/valid_scores_RF_liar.json")
data4 = load_data("../../outputs/random_forest/valid_scores_RF_nela.json")
data5 = load_data("../../outputs/random_forest/valid_scores_RF_tfg.json")
data6 = load_data("../../outputs/random_forest/valid_scores_RF_ti_cnn.json")
...
plt.tight_layout()
plt.savefig("../../figs/random_forest_graph.pdf", dpi=600)
